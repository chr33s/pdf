...
import { Struct, String as StringT, Pointer, uint8, DecodeStream, EncodeStream } from '../src';
...
describe('Struct', () => {
  describe('decode', () => {
    ...
    it('should support process hook', () => {
      ...
      expect(struct.decode(stream)).to.deep.equal({ name: 'devon', age: 32, canDrink: true });
    });
