...
const integerCases: IntegerCase[] = [
  ...
  { name: 'uint32be', type: uint32be, buffer: [0xff, 0xab, 0x24, 0xbf], expected: [0xffab24bf], size: 4 },
  { name: 'uint32le', type: uint32le, buffer: [0xbf, 0x24, 0xab, 0xff], expected: [0xffab24bf], size: 4 },
  ...
  { name: 'int32be', type: int32be, buffer: [0xff, 0xab, 0x24, 0xbf], expected: [-5561153], size: 4 },
  { name: 'int32le', type: int32le, buffer: [0xbf, 0x24, 0xab, 0xff], expected: [-5561153], size: 4 },
];
...
const floatCases: FloatCase[] = [
  { name: 'floatbe', type: floatbe, buffer: [0x43, 0x7a, 0x8c, 0xcd], expected: 250.55, size: 4, precision: 0.005 },
  { name: 'floatle', type: floatle, buffer: [0xcd, 0x8c, 0x7a, 0x43], expected: 250.55, size: 4, precision: 0.005 },
  { name: 'doublebe', type: doublebe, buffer: [0x40, 0x93, 0x4a, 0x3d, 0x70, 0xa3, 0xd7, 0x0a], expected: 1234.56, size: 8 },
  { name: 'doublele', type: doublele, buffer: [0x0a, 0xd7, 0xa3, 0x70, 0x3d, 0x4a, 0x93, 0x40], expected: 1234.56, size: 8 },
  { name: 'fixed16be', type: fixed16be, buffer: [0x19, 0x57], expected: 25.34, size: 2, precision: 0.005 },
  { name: 'fixed16le', type: fixed16le, buffer: [0x57, 0x19], expected: 25.34, size: 2, precision: 0.005 },
  { name: 'fixed32be', type: fixed32be, buffer: [0x00, 0xfa, 0x8c, 0xcc], expected: 250.55, size: 4, precision: 0.005 },
  { name: 'fixed32le', type: fixed32le, buffer: [0xcc, 0x8c, 0xfa, 0x00], expected: 250.55, size: 4, precision: 0.005 },
];
