...
export default class PDFTextField extends PDFField {
   ...
   *
   * An error will be thrown if this is a rich text field. `pdf` does not
   ...
   * field in order to set the text. `pdf` does not support writing rich
   ...
   * ```
   * Note that `pdf` does not support reading or writing rich text fields.
