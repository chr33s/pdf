...
class ViewerPreferences {
   ...
   * For example:
   * ```js
   * import { PDFDocument, NonFullScreenPageMode, PDFName } from 'pdf'
   *
   ...
   * For example:
   * ```js
   * import { PDFDocument, ReadingDirection } from 'pdf'
   *
   * const pdfDoc = await PDFDocument.create()
   * const viewerPrefs = pdfDoc.catalog.getOrCreateViewerPreferences()
   ...
   * For example:
   * ```js
   * import { PDFDocument, PrintScaling } from 'pdf'
   *
   * const pdfDoc = await PDFDocument.create()
   * const viewerPrefs = pdfDoc.catalog.getOrCreateViewerPreferences()
   ...
   * For example:
   * ```js
   * import { PDFDocument, Duplex } from 'pdf'
   *
   * const pdfDoc = await PDFDocument.create()
   * const viewerPrefs = pdfDoc.catalog.getOrCreateViewerPreferences()
