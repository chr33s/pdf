...
`pdf` was created to address the JavaScript ecosystem's lack of robust support for PDF manipulation (especially for PDF _modification_).

Two of `pdf`'s distinguishing features are:
...
<!-- prettier-ignore -->
```js
import { PDFDocument, StandardFonts, rgb } from '@chr33s/pdf'
...
<!-- prettier-ignore -->
```js
import { degrees, PDFDocument, rgb, StandardFonts } from '@chr33s/pdf';
...
<!-- prettier-ignore -->
```js
import { PDFDocument, StandardFonts } from '@chr33s/pdf'
...
pdfDoc.setCreator('pdf (https://github.com/chr33s/pdf)')
...
API documentation is available on the project site at https://pdf.js.org/docs/api/.
...
`pdf` does its best to simplify things for you. But it can't perform magic. This means you should be aware of the following:
...
Embedding a font in a PDF document will typically increase the file's size. You can reduce the amount a file's size is increased by subsetting the font so that only the necessary characters are embedded. You can subset a font by setting the [`subset` option](https://pdf.js.org/docs/api/interfaces/embedfontoptions#optional-subset) to `true`. For example:
...
`pdf` can create, fill, and read PDF form fields. The following field types are supported:

- [Buttons](https://pdf.js.org/docs/api/classes/pdfbutton)
- [Check Boxes](https://pdf.js.org/docs/api/classes/pdfcheckbox)
- [Dropdowns](https://pdf.js.org/docs/api/classes/pdfdropdown)
- [Option Lists](https://pdf.js.org/docs/api/classes/pdfoptionlist)
- [Radio Groups](https://pdf.js.org/docs/api/classes/pdfradiogroup)
- [Text Fields](https://pdf.js.org/docs/api/classes/pdftextfield)
...
const fontUrl = 'https://pdf.js.org/assets/ubuntu/Ubuntu-R.ttf';
...
Existing form fields can be accessed with the following methods of [`PDFForm`](https://pdf.js.org/docs/api/classes/pdfform):

- [`PDFForm.getButton`](https://pdf.js.org/docs/api/classes/pdfform#getbutton)
- [`PDFForm.getCheckBox`](https://pdf.js.org/docs/api/classes/pdfform#getcheckbox)
- [`PDFForm.getDropdown`](https://pdf.js.org/docs/api/classes/pdfform#getdropdown)
- [`PDFForm.getOptionList`](https://pdf.js.org/docs/api/classes/pdfform#getoptionlist)
- [`PDFForm.getRadioGroup`](https://pdf.js.org/docs/api/classes/pdfform#getradiogroup)
- [`PDFForm.getTextField`](https://pdf.js.org/docs/api/classes/pdfform#gettextfield)

New form fields can be created with the following methods of [`PDFForm`](https://pdf.js.org/docs/api/classes/pdfform):

- [`PDFForm.createButton`](https://pdf.js.org/docs/api/classes/pdfform#createbutton)
- [`PDFForm.createCheckBox`](https://pdf.js.org/docs/api/classes/pdfform#createcheckbox)
- [`PDFForm.createDropdown`](https://pdf.js.org/docs/api/classes/pdfform#createdropdown)
- [`PDFForm.createOptionList`](https://pdf.js.org/docs/api/classes/pdfform#createoptionlist)
- [`PDFForm.createRadioGroup`](https://pdf.js.org/docs/api/classes/pdfform#createradiogroup)
- [`PDFForm.createTextField`](https://pdf.js.org/docs/api/classes/pdfform#createtextfield)

Below are some of the most commonly used methods for reading and filling the aforementioned subclasses of [`PDFField`](https://pdf.js.org/docs/api/classes/pdffield):

- [`PDFCheckBox.check`](https://pdf.js.org/docs/api/classes/pdfcheckbox#check)
- [`PDFCheckBox.uncheck`](https://pdf.js.org/docs/api/classes/pdfcheckbox#uncheck)
- [`PDFCheckBox.isChecked`](https://pdf.js.org/docs/api/classes/pdfcheckbox#ischecked)

---

- [`PDFDropdown.select`](https://pdf.js.org/docs/api/classes/pdfdropdown#select)
- [`PDFDropdown.clear`](https://pdf.js.org/docs/api/classes/pdfdropdown#clear)
- [`PDFDropdown.getSelected`](https://pdf.js.org/docs/api/classes/pdfdropdown#getselected)
- [`PDFDropdown.getOptions`](https://pdf.js.org/docs/api/classes/pdfdropdown#getoptions)
- [`PDFDropdown.addOptions`](https://pdf.js.org/docs/api/classes/pdfdropdown#addoptions)

---

- [`PDFOptionList.select`](https://pdf.js.org/docs/api/classes/pdfoptionlist#select)
- [`PDFOptionList.clear`](https://pdf.js.org/docs/api/classes/pdfoptionlist#clear)
- [`PDFOptionList.getSelected`](https://pdf.js.org/docs/api/classes/pdfoptionlist#getselected)
- [`PDFOptionList.getOptions`](https://pdf.js.org/docs/api/classes/pdfoptionlist#getoptions)
- [`PDFOptionList.addOptions`](https://pdf.js.org/docs/api/classes/pdfoptionlist#addoptions)

---

- [`PDFRadioGroup.select`](https://pdf.js.org/docs/api/classes/pdfradiogroup#select)
- [`PDFRadioGroup.clear`](https://pdf.js.org/docs/api/classes/pdfradiogroup#clear)
- [`PDFRadioGroup.getSelected`](https://pdf.js.org/docs/api/classes/pdfradiogroup#getselected)
- [`PDFRadioGroup.getOptions`](https://pdf.js.org/docs/api/classes/pdfradiogroup#getoptions)
- [`PDFRadioGroup.addOptionToPage`](https://pdf.js.org/docs/api/classes/pdfradiogroup#addoptiontopage)

---

- [`PDFTextField.setText`](https://pdf.js.org/docs/api/classes/pdftextfield#settext)
- [`PDFTextField.getText`](https://pdf.js.org/docs/api/classes/pdftextfield#gettext)
- [`PDFTextField.setMaxLength`](https://pdf.js.org/docs/api/classes/pdftextfield#setmaxlength)
- [`PDFTextField.getMaxLength`](https://pdf.js.org/docs/api/classes/pdftextfield#getmaxlength)
- [`PDFTextField.removeMaxLength`](https://pdf.js.org/docs/api/classes/pdftextfield#removemaxlength)

## Limitations

- `pdf` **can** extract the content of text fields (see [`PDFTextField.getText`](https://pdf.js.org/docs/api/classes/pdftextfield#gettext)), but it **cannot** extract plain text on a page outside of a form field. This is a difficult feature to implement, but it is within the scope of this library and may be added to `pdf` in the future. See
...
- `pdf` **can** remove and edit the content of text fields (see [`PDFTextField.setText`](https://pdf.js.org/docs/api/classes/pdftextfield#settext)), but it does **not** provide APIs for removing or editing text on a page outside of a form field. This is also a difficult feature to implement, but is within the scope of `pdf` and may be added in the future. See
  [#93](https://github.com/chr33s/pdf/issues/93),
  [#137](https://github.com/chr33s/pdf/issues/137),
  [#177](https://github.com/chr33s/pdf/issues/177),
  [#329](https://github.com/chr33s/pdf/issues/329), and
  [#380](https://github.com/chr33s/pdf/issues/380).
- `pdf` does **not** support the use of HTML or CSS when adding content to a PDF. Similarly, `pdf` **cannot** embed HTML/CSS content into PDFs. As convenient as such a feature might be, it would be extremely difficult to implement and is far beyond the scope of this library. If this capability is something you need, consider using [Puppeteer](https://github.com/puppeteer/puppeteer).
...
**`@chr33s/pdf` does support encrypted documents.**
...
- [How to use pdf in AWS Lambdas](https://medium.com/swlh/create-pdf-using-pdf-on-serverless-aws-lambda-e9506246dc88) - a tutorial written by Crespo Wang
- [Working With PDFs in Node.js Using pdf](http://thecodebarbarian.com/working-with-pdfs-in-node-js.html) - a tutorial by Valeri Karpov
...
- [`react-native-pdf`](https://github.com/Hopding/react-native-pdf) is a PDF generation and modification library for React Native environments. `react-native-pdf` is a wrapper around [C++](https://github.com/galkahana/PDF-Writer) and [Java](https://github.com/TomRoush/PdfBox-Android) libraries.
...
```
$ git clone git@github.com:Hopding/pdf.git
$ cd pdf
...
If you're a user of `pdf`, you shouldn't care! Just keep on using `pdf` like normal 😃 ✨!

If you are a `pdf` developer (meaning you've forked `pdf` and/or have an open PR) then this does impact you. If you forked or cloned the repo prior to 8/30/2021 then your fork's git history is out of sync with this repo's `master` branch. Unfortunately, this will likely be a headache for you to deal with. Sorry! We didn't want to rewrite the history, but there really was no alternative.

It's important to note that pdf's _source code_ has not changed at all. It's exactly the same as it was before the git history rewrite. The repo still has the exact same number of commits (and even the same commit contents, except for the commit that added `pdf_specification.pdf`). What has changed are the SHAs of those commits.
