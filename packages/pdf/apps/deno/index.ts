...
const loadAssets = async () => ({
  fonts: {
    ...
    otf: {
      "fantasque-sans-mono_bi": await readBinaryAsset("fantasque-sans-mono-bold-italic.otf"),
      "apple-storm_r": await readBinaryAsset("apple-storm-c-bo.otf"),
      "hussar-3d_r": await readBinaryAsset("hussar-3d-four.otf"),
      "source-hans-jp": await readBinaryAsset("source-han-serif-jp-regular.otf"),
    },
  },
  images: {
    jpg: {
      "cat-riding-unicorn": await readBinaryAsset("cat-riding-unicorn.jpg"),
      "cat-riding-unicorn_base64": await readTextAsset("cat-riding-unicorn.jpg.base64"),
    ...
    png: {
      ...
      "greyscale-bird_base64_uri": await readTextAsset("greyscale-bird.png.base64.uri"),
      "minions-banana_alpha": await readBinaryAsset("minions-banana-alpha.png"),
      "minions-banana_no_alpha": await readBinaryAsset("minions-banana-no-alpha.png"),
  ...
  pdfs: {
    ...
    with_update_sections_base64_uri: await readTextAsset("with_update_sections.pdf.base64.uri"),
    linearized_with_object_streams: await readBinaryAsset("linearized-with-object-streams.pdf"),
    ...
    simple_pdf_2_example: await readBinaryAsset("pdf20examples/simple-p-d-f-2.0-file.pdf"),
