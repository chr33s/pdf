...
import { PDFHexString } from "../../../src/core/index.js";
import { toCharCode, typedArrayFor } from "../../../src/utils/index.js";

describe("PDFHexString", () => {
  test("can be constructed from PDFHexString.of(...)", () => {
  ...
  test("can be constructed from a string of text (using UTF-16BE encoding)", () => {
  ...
  describe("converting to bytes", () => {
    test("can handle an even number of hex digits", () => {
  ...
  describe("decoding to string", () => {
    test("can interpret UTF-16BE strings", () => {
      const hex = "FEFF0045006700670020D83CDF73";
      expect(PDFHexString.of(hex).decodeText()).toBe("Egg 🍳");
    });

    test("can interpret UTF-16LE strings", () => {
