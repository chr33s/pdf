...
import { AES, AESHelper, NoPadding, OFB, WordArray } from "../src/index.js";
...
describe("OFB Mode", () => {
  ...
  describe("decryptor", () => {
    test("should decrypt correctly with OFB mode", () => {
