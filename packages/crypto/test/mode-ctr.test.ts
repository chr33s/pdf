...
import { AES, AESHelper, CTR, NoPadding, WordArray } from "../src/index.js";
...
describe("CTR Mode", () => {
  ...
  describe("decryptor", () => {
    test("should decrypt correctly with CTR mode", () => {
