...
import { init as initCompressedDictionary } from "./dictionary-data-compressed.js";
...
const BrotliDictionary = {
  ...
  init(BrotliDecompressBuffer) {
    this.dictionary = initCompressedDictionary(BrotliDecompressBuffer);
  },
};

export default BrotliDictionary;
export { offsetsByLength, sizeBitsByLength };
