...
import { PDFDocument, rgb, TextAlignment } from "@chr33s/pdf";
import { assets } from "./assets.js";

test("Test 14: DOD character sheet", async () => {
  ...
  const emblemImage = await pdfDoc.embedPng(await assets.images.png.marioEmblem());
